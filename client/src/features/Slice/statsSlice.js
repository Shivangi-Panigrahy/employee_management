...
export const fetchDepartmentSalaries = createAsyncThunk(
  "stats/departmentSalaries",
  async () => {
    const response = await axios.get(`${API_URL}/department-highest-salary`);
    return response.data;
  }
);

export const fetchSalaryRanges = createAsyncThunk(
  "stats/salaryRanges",
  async () => {
...
export const fetchYoungestEmployees = createAsyncThunk(
  "stats/youngestEmployees",
  async () => {
...
const statsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(fetchDepartmentSalaries.pending, (state) => {
        state.loading = true;
      })
